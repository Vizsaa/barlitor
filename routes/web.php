...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/receipts/{transactionId}/download', [ReceiptController::class, 'download'])->name('receipts.download');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::post('/users/{id}/status', [AdminController::class, 'updateStatus'])->name('admin.users.updateStatus');
