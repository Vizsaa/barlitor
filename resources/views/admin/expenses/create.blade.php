    ...
    <div class="bg-[#1a1a1a] rounded-xl border border-gray-800 shadow-sm overflow-hidden mb-8">
        <div class="px-6 py-5 border-b border-gray-800 bg-[#111111]">
            <h3 class="text-lg font-bold text-white flex items-center">
                <i class="fa-solid fa-plus text-orange-500 mr-2"></i> Record New Expense
            </h3>
        </div>
            ...
            <form method="POST" action="{{ route('admin.expenses.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" class="bg-[#111111] border border-gray-700 text-white text-sm rounded-md focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 transition-colors" value="{{ old('title') }}" required placeholder="e.g. Office Supplies">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0.01" name="amount" class="bg-[#111111] border border-gray-700 text-white text-sm rounded-md focus:ring-orange-500 focus:border-orange-500 block w-full pl-8 p-2.5 transition-colors" value="{{ old('amount') }}" required placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="expense_date" class="bg-[#111111] border border-gray-700 text-white text-sm rounded-md focus:ring-orange-500 focus:border-orange-500 block w-full pl-10 p-2.5 transition-colors" value="{{ old('expense_date', date('Y-m-d')) }}" required>
                        </div>
                    </div>
                    
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-300 mb-2">Notes (optional)</label>
                        <textarea name="notes" rows="3" class="bg-[#111111] border border-gray-700 text-white text-sm rounded-md focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 transition-colors" placeholder="Additional details...">{{ old('notes') }}</textarea>
                    </div>
                </div>
