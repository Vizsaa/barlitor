                                ...
                                <div class="relative group">
                                    ...
                                    <div class="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-[#262626] ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                        <div class="py-1" role="menu" aria-orientation="vertical">
                                            ...
                                            <a href="{{ route('admin.orders.index') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white">Orders</a>
                                            ...
                                            <a href="{{ route('admin.reviews.index') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white">Reviews</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                ...
                @auth
                    @if(auth()->user()->isAdmin())
                        <div class="border-t border-gray-700 mt-2 pt-2">
                            ...
                            <a href="{{ route('admin.orders.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Orders</a>
                            ...
                            <a href="{{ route('admin.reviews.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Reviews</a>
                        </div>
                    @endif
                @endauth
            </div>
