...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
        ...
        <!-- Image Section -->
        <div>
            <div class="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden shadow-2xl relative aspect-square md:aspect-auto md:h-[500px] flex items-center justify-center">
                @php
                    $img = $item->image_path ? asset($item->image_path) : asset('images/default.png');
                @endphp
                <img src="{{ $img }}" alt="{{ $item->title }}" class="w-full h-full object-contain p-4 mix-blend-lighten">
