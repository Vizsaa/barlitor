...
<body class="bg-[#111111] text-gray-200 font-sans antialiased min-h-screen flex">
    
    <!-- Sidebar -->
    <aside class="w-64 bg-[#1a1a1a] border-r border-gray-800 hidden md:flex flex-col flex-shrink-0 sticky top-0 h-screen overflow-y-auto">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-[#1a1a1a] border-b border-gray-800 h-16 flex items-center justify-between px-4 sm:px-6 z-10 sticky top-0">
