...
if (!empty($keyword)) {
    ...
    $sql .= " AND (LOWER(title) LIKE '%{$keywordEscaped}%' OR LOWER(description) LIKE '%{$keywordEscaped}%')";
}
...
switch ($sort) {
    ...
    case 'oldest':
        ...
        break;
    case 'type':
        $sql .= " ORDER BY type ASC, title ASC";
        break;
    default:
        ...
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <div class="col-md-4 col-lg-3">
                <div class="card h-100 shadow-sm border-0">
                    <a href="show.php?id=<?= $row['item_id'] ?>">
                    ...
                    <div class="card-body">
                        <h5 class="card-title mb-2">
                            <a href="show.php?id=<?= $row['item_id'] ?>" class="text-decoration-none text-dark">
                        ...
                        <p class="card-text small text-muted mb-1">
                            Type: <strong><?= ucfirst($row['type'] ?? 'N/A') ?></strong>
                        </p>
